...
<template>
  <aside class="flex h-full min-h-0 w-full flex-col border-l border-gray-200 bg-white/70 dark:border-white/10 dark:bg-zinc-950/55">
    <div class="flex h-9 shrink-0 items-center gap-0.5 border-b border-gray-200 px-1 dark:border-white/10">
      <button
        v-for="tab in tabs"
        :key="tab.value"
        type="button"
