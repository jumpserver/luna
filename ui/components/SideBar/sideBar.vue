  ...
  >
    <div class="flex flex-col w-full">
      <div
        ...
        class="flex h-[var(--workspace-toolbar-height)] items-center gap-px border-b border-[color:var(--sidebar-divider-light)] px-2.5 dark:border-[color:var(--sidebar-divider-dark)]"
      >
