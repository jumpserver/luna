...
import type { HostBridge } from "~/shared/connectors/useHostBridge";
...
import { FORMATTER_MESSAGE_TYPE, HOST_MESSAGE_TYPE } from "~/shared/connectors/types/message";
import { createHostBridge } from "~/shared/connectors/useHostBridge";
...
export const createKokoTerminalContext = (): TerminalContext => {
  ...
  const initializeHostListeners = () => {
    ...
    hostBridge.onHost(HOST_MESSAGE_TYPE.TERMINAL_THEME_CHANGE, (message) => handleHostThemeChange({ theme: message.theme }));
