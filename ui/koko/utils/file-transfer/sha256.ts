...
export function parseSha256State(value: string): Sha256State {
...
export function updateSha256(state: Sha256State, bytes: Uint8Array) {
...
export function finalizeSha256(source: Sha256State) {
...
function sha256HexJs(bytes: Uint8Array) {
  const state = parseSha256State("");
