...
if (
  copyIfPresent(
    [path.join(sourceDir, "public", "logo.png"), path.join(sourceDir, "logo.png")],
...
for (const file of iconFiles) {
  if (
    copyIfPresent(
      [
        path.join(sourceDir, "electron", "assets", "icons", file),
        path.join(sourceDir, "icons", file),
        path.join(sourceDir, file)
      ],
      path.join(repoRoot, "electron", "assets", "icons", file)
    )
  ) {
    copied++;
  }
